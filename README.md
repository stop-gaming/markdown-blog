...
- The *Markdown files* **only** in the [/drafts](/drafts) and [/published](/published) directories will be **synchronized** to your blog as **posts**.
    ...
    - To trigger the synchronization, you need to create your *GitHub App* and install it on this repository. Please read [developer-portfolio-engine GitHub_App.md](https://github.com/developer-portfolios/developer-portfolio-engine/blob/main/documents/GitHub_App.md).
