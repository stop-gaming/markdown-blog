...
- The *Markdown files* **only** in the [/drafts](/drafts) and [/published](/published) directories will be **synchronized** to your blog as **posts**.
    ...
    - To trigger the synchronization, you need to create your *GitHub App* and install it on this repository. Please read [personal-brand-website-builder GitHub_App.md](https://github.com/PersonalBranding/personal-brand-website-builder/blob/main/documents/GitHub_App.md).
